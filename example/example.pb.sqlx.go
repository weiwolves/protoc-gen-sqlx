...
func NewQueryExampleItem(verbose int) *QueryExampleItem {
	p := QueryExampleItem{
		...
		defFields: ExampleItemFieldsMap(),
		limit:     1000,
		offset:    0,
		sort:      "id",
		order:     "ASC",
	}
	p.table = ExampleItemTableName()
	p.field = ExampleItemFieldsString()
	return &p
}
...
func ExampleItemTableName() string {
	return "example_items"
}

func ExampleItemFieldsString() string {
...
func ExampleItemFieldsMap() map[string]interface{} {
...
func NewQueryExample(verbose int) *QueryExample {
	p := QueryExample{
		...
		defFields: ExampleFieldsMap(),
		limit:     1000,
		offset:    0,
		sort:      "id",
		order:     "ASC",
	}
	p.table = ExampleTableName()
	p.field = ExampleFieldsString()
	return &p
}
...
func ExampleFieldsString() string {
...
func ExampleFieldsMap() map[string]interface{} {
	set := make(map[string]interface{})
	set["id"] = "id"
	set["created_at"] = "created_at"
	set["updated_at"] = "updated_at"
